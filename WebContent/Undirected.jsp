	...
	<div id=outer>
		...
		<a>
			<h3>
				...
				<h3>
					<h6>Undirected and Positive Edges</h6>
					<img src="direct.png" width="200" height="200">
		</a>
	</div>

<div class="grid">
	<h3 align="center" style="color:white"> Upload File</h3>
<form action="FileUploadHandler" method="post" enctype="multipart/form-data" align="right" class="form login">
                ...
                <input id="file" type="file" class="form_input" name="file" placeholder="Add file" required/>
                </div>
                <div class="form__field">
				<input type=hidden name="gtype" value="UN">
				</div>
                <div class="form__field">
